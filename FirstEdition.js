...
FirstEdition.spellsDescriptions = {
  ...
  'Airy Water':"Water in 10' radius sphere around self becomes breathable for $L turns",
  ...
  'Animal Summoning II':"R${lvl*180}' Draw 6 8 HD or 12 4 HD animals to assist",
  'Animal Summoning III':"R${lvl*240}' Draw 4 16 HD or 16 4 HD animals to assist",
  ...
  'Anti-Animal Shell':"10' radius immobile sphere blocks animal matter for $L turns",
  'Anti-Magic Shell':"$L5' radius sphere allows no magic inside, moves with self for $L turns",
  'Anti-Plant Shell':"80' radius immobile sphere blocks plant matter for $L turns",
  'Antipathy/Sympathy':"R30' $L10' cu or object attracts or repels specified creature type for $L12 turns (save reduces effect)",
  'Arcane Spells Level 1':"Memorize ${lvl-7} first level MU spells",
  'Astral Spell':"Self and five companions leave bodies to travel astral plane",
  'Atonement':"Touched relieved of consequences of unwilling alignment violation",
  'Audible Glamer':"R${lvl*10 + 60}' Sounds of ${(lvl-2)*4} shouting for $L2 rd (save disbelieve)",
  'Audible Glamer(I1 Illu)':"R${lvl*10 + 60}' Sounds of ${(lvl-2)*4} shouting for $L3 rd (save disbelieve)",
  'Augury':"Self ${lvl+70}% chance of determining weal/woe of action in next 3 turns",
  'Barkskin':"Touched +1 AC, non-spell saves for $Lplus4 rd",
  'Blade Barrier':"R30' Whirling blade wall 8d8 HP to passers",
  'Bless':"R60' Unengaged allies in 25' radius circle +1 attack/morale (rev foes -1) for 6 rds",
  ...
  'Call Lightning':"R360' Clouds release ${lvl+2}d8 10' bolt 1/turn for $L turns",
  ...
  'Confusion':"R120' 2d8 or more creatures in 60' sq unpredictable for $Lplus2 rd",
  'Confusion(D7 Ench)':"R80' 2d4 or more creatures in 20' radius unpredictable for $L rd",
  'Confusion(I4 Ench)':"R80' 2d8 or more creatures in 40' sq unpredictable for $L rd",
  ...
  'Continual Darkness':"R60' 30' opaque sphere",
  'Continual Light':"R60' Target centers 60' radius light sphere (rev darkness) until dispelled",
  'Continual Light(C3 Tran)':"R120' Target centers 60' radius light sphere (rev darkness) until dispelled",
  "Control Temperature 10' Radius":"Change temperature in 10' radius by ${lvl*9} deg F for $Lplus4 turns",
  ...
  'Control Winds':"Winds in 40' radius of self increase $L3 mph/rd for $L turns",
  'Create Food And Water':"R10' Creates $L person/days food and drink",
  'Create Water':"R10' Creates (rev destroys) $L4 gallons potable water in 30' cu",
  'Create Water(D2 Tran)':"R10' Creates $L4 gallons potable water in $L' cu",
  ...
  'Darkness':"R$L10' 15' lightless sphere for $Lplus10 rd",
  'Darkness(I1 Tran)':"R${lvl*10+40}' 15' lightless sphere for 2d4+$L rd",
  'Deafness':"R60' Target deafened (save neg)",
  'Death Spell':"R$L10' Kills creatures lt 9 HD in ${lvl*25}' sq area",
  'Delayed Blast Fireball':"R${lvl*10+100}' ${lvl}d6+$L HP in 20' radius (save half) after up to 5 min",
  'Fireball':"R${lvl*10+100}' ${lvl}d6 HP in 20' radius (save half)",
  ...
  'Detect Evil(C1 Divi)':"Self discern evil (rev good) in 10'x120' path for ${lvl*5+10} rd",
  ...
  'Dig':"R30' Excavate 5'x5'x5'/rd for $L rd",
  ...
  'Dispel Magic(C3 Abju)':"R60' 50% (+5%/-2% per caster level delta) magic in 30' cu extinguished",
  'Dispel Magic(D4 Abju)':"R80' 50% (+5%/-2% per caster level delta) magic in 40' cu extinguished",
  'Dispel Magic':"R120' 50% (+5%/-2% per caster level delta) magic in 30' cu extinguished",
  'Distance Distortion':"R$L10' Travel through $L100' sq area halved or doubled for $L turns",
  'Divination':"Self ${lvl+60}% chance discern info about known location",
  ...
  'Feign Death(D2 Necr)':"R10' Target appears dead, takes half damage, immune draining for ${lvl*2+4} rd",
  'Find Familiar':"Call beast to serve as familiar (HP 1d3+1, AC 7, Int 6)",
  'Find The Path':"Touched knows shortest route into/out of location for 3 rd (rev causes indirection)",
  ...
  'Fire Seeds':"R40' Acorn missiles 2d8 HP in 5' area, holly berries 1d8 in 5' sq for $L turns",
  'Fire Shield':"Self +2 save and half damage vs. fire (rev cold), double damage vs. cold (rev fire) for $Lplus2 rd",
  'Fire Storm':"R150' Fire in ${lvl*8000}' cu 2d8 HP for 1 rd (save half) (rev extinguishes)",
  ...
  'Flame Strike':"R60' 10' diameter fire column 6d8 HP (save half)",
  ...
  'Fog Cloud':"R10' 1600' cu obscures vision, moves 10'/rd for $Lplus4 rd",
  ...
  'Globe Of Invulnerability':"Self 5' radius sphere blocks spells level 1-4 for $L rd",
  ...
  'Guards And Wards':"Multiple effects protect ${lvl*4000}' cu for $L2 hr",
  'Gust Of Wind':"Wind in 10'x$L10' path extinguishes flames, moves small objects for 6 secs",
  'Hallucinatory Forest':"R80' Illusion of ${lvl*40}' sq forest",
  'Hallucinatory Terrain':"R$L20' $L100' sq area mimics other terrain until touched",
  'Hallucinatory Terrain(I3 Illu)':"R${lvl*20+20}' ${lvl*100+1600}' sq area mimics other terrain until touched",
  ...
  'Hold Person(C2 Ench)':"R60' Immobilize 1-4 medium targets (save neg) for $Lplus4 rd",
  'Hold Plant':"R80' Mobile plants in 16 sq yd immobile for $L 4d",
  'Hold Portal':"R$L20' $L100' sq item held closed for $L rd",
  ...
  'Hypnotic Pattern':"Viewers totalling 25 HD transfixed for conc (save neg)",
  ...
  'Infravision':"Touched see 60' in darkness for ${lvl*6+12} turns",
  ...
  'Invisibility To Animals':"Touched undetected by animals until attack/1 turn + $L rd",
  ...
  'Know Alignment':"Self discern aura of 10 touched creatures in 1 turn (rev obscures)",
  ...
  'Light':"R60' Target spot radiates light 20' for $L turns (rev darkness half duration)",
  'Light(C1 Tran)':"R120' Target spot radiates light 20' for $Lplus6 turns (rev darkness half duration)",
  'Lightning Bolt':"R${lvl*10+40}' Bolt ${lvl}d6 HP (save half)",
  'Limited Wish':"Minor reshaping of reality",
  'Locate Animals':"Self discern animals in 20'x${lvl*20}' area for $L rd",
  'Locate Object':"R$L20' Self find desired object for $L rd (rev obscures)",
  'Locate Object(C3 Divi)':"R${lvl*10 + 60}' Self find desired object for $L rd (rev obscures)",
  'Locate Plants':"Self discern plants in $L5' radius for $L turns",
  'Lower Water':"R80' $L5'x$L5' sq fluid subsides by $L5% for $L5 rd (rev raises $L')",
  ...
  'Magic Missile':"R${lvl*10 + 60}' ${Math.floor((lvl+1)/2)} energy darts hit targets in 10' cu 1d4+1 HP ea",
  ...
  'Mass Charm':"R$L5' $L2 HD creature(s) in 30'x30' treat self as trusted friend (save neg)",
  ...
  'Message':"R${lvl*10+60}' remote whispering for ${(lvl+5)*6} secs",
  'Meteor Swarm':"R${lvl*10+40}' 4 meteors 10d4 HP in 15' radius or 8 meteors 5d4 HP in 7.5' radius (collateral save half)",
  ...
  'Minor Globe Of Invulnerability':"Self $L5' radius sphere blocks spells level 1-3 for $L rd",
  ...
  'Misdirection':"Divination spells cast on target return false info for $L rd",
  ...
  'Part Water':"R$L10' Form trench from ${lvl*600}' sq water for $L5 rd",
  'Part Water(C6 Tran)':"R$L20' Form trench from ${lvl*600}' sq water for $L turns",
  ...
  'Phantasmal Force':"R${lvl*10 + 80}' ${lvl*10 + 80}' sq illusionary object for conc/until struck",
  'Phantasmal Force(I1 Illu)':"R${lvl*10 + 60}' ${lvl*10 + 40}' sq illusionary object for conc/until struck",
  ...
  'Plant Growth(D3 Tran)':"R160' Vegetation in ${lvl*400}' sq becomes thick and entangled",
  ...
  'Prismatic Sphere':"Self 10' radius sphere impenetrable for $L turns",
  ...
  "Protection From Evil 10' Radius(C4 Abju)":"Touched 10' radius untouchable by evil outsiders, -2 evil attacks, +2 saves for $L turn(rev good)",
  ...
  'Push':"R${lvl*3+10}' Target $L lb object moves away from self",
  ...
  'Ray Of Enfeeblement':"R${lvl*3+10}' Target loses ${lvl+25}% Str, damage for $L rd",
  ...
  'Remove Fear':"Touched +4 vs. fear for 1 turn, new +$L save if already afraid (rev cause fear, save neg)",
  'Repel Insects':"Touched immune normal insects, protected giant (save neg) for $L turns",
  ...
  'Sleep':"R${lvl*10+30}' Creatures up to 4+4 HD in 15' radius sleep for $L5 rd",
  'Slow':"R${lvl*10+90}' $L targets in 40' sq half speed for $Lplus3 rd",
  ...
  'Snare':"Touched snare 90% undetectable, 23 Str to break for 12 hr",
  ...
  'Speak With Plants':"Self converse w/plants w/in 60' for $L rd",
  'Speak With Plants(D4 Tran)':"Self converse w/plants w/in 40' for $L rd",
  ...
  'Sticks To Snakes(D4 Tran)':"R40' $L sticks in 5' radius become snakes ($L5% venonous) (rev) for $L2 rd",
  ...
  'Suggestion':"R30' Target carries out reasonable suggestion for ${lvl*6+6} turns",
  'Suggestion(I3 Ench)':"R30' Target carries out reasonable suggestion for ${lvl*4+4} turns",
  ...
  'Transmute Rock To Mud':"R$L10' ${lvl*8000}' cu rock becomes mud (rev)",
  'Transmute Rock To Mud(D5 Tran)':"R160' ${lvl*8000}' cu rock becomes mud (rev)",
  ...
  'Wall Of Ice':"R$L10' Create $L100' sq, $L10' thick ice wall for $L turns",
  'Wall Of Iron':"R$L5' Create ${lvl/4}\" thick, $L15' sq wall",
  'Wall Of Stone':"R$L5' ${lvl/4}\" thick, ${lvl*400}' sq wall emerges from stone",
  'Wall Of Thorns':"R80' $L100' cu briars 8 + AC HP for $L turns",
  'Warp Wood':"R$L10' Bends 1\"x$L15\" wood",
  'Water Breathing':"Touched breathe water (rev air) for $L rd",
