...
FirstEdition.spellsDescriptions = {
  ...
  'Antipathy/Sympathy':"R30' $L10' cu or object attracts or repels specified creature type for $L12 turns",
  ...
  'Charm Plants':"R30' Command plants in 30'x10' area for 1 turn",
  ...
  'Clone':"Grow copy from target creature, each destroy the other or insane",
  ...
  'Cone Of Cold':"$L5'-long cone ${lvl}d4+$L HP",
  'Confusion':"R80' 2d4 or more creatures in 20' radius unpredictable for $L rd",
  ...
  'Contact Other Plane':"Gain answers to ${Math.floor(lvl/2)} yes/no questions",
  ...
  'Control Weather':"Self controls precipitation, temp, and wind within 4d4 mi for 4d12 hr",
  ...
  'Detect Magic':"Self discern magical auras in 10'x30' path for 1 turn",
  ...
  'ESP':"R${Math.min(lvl*5,90)}' Self hear others' surface thoughts",
  ...
  'Feeblemind':"R40' Target Int reduced (save Cleric +1, Druid -1, MU/Illusionist -4 neg)",
  ...
  'Fire Charm':"R10' Fire mesmerizes viewers (save neg), makes suggestible for $L2 rd",
  ...
  'Fireball':"R${lvl*10+100}' ${lvl}d6 HP in 20' radius (save half)",
  'Flame Arrow':"Touched arrow 1 HP fire damage within 1 rd",
  ...
  "Fool's Gold":"R10' Copper becomes gold for $L6 turns (observer save disbelieve)",
  ...
  'Geas':"Target fulfill quest or sicken and die in 1d4 wk",
  ...
  'Globe Of Invulnerability':"5' radius sphere around self blocks spells level 1-4 for $L rd",
  ...
  'Gust Of Wind':"Wind in 10'x$L10' extinguishes flames, moves small objects",
  ...
  'Knock':"R60' Open stuck, locked items",
  ...
  'Lightning Bolt':"R${lvl*10+40}' Bolt ${lvl}d6 HP",
  'Limited Wish':"Minor reshaping of reality",
  'Locate Animals':"Self discern animals in 20'x${lvl*20}' area for $L rd",
  'Locate Object':"R${lvl*10 + 60}' Self find desired object for $L rd (rev obscures)",
  'Locate Plants':"Self discern plants in $L5' radius for $L turns",
  'Lower Water':"R120' $L10'x$L10' fluid subsides by $L5% for $L turns (rev raises $L')",
  ...
  'Mass Invisibility':"R10' All in 30' radius invisible until attacking",
  ...
  'Mirror Image':"Self 1d4 duplicates draw attacks for $L2 rd",
  ...
  'Part Water':"R$L20' Form trench from ${lvl*600}' sq water for $L turns",
  ...
  'Phase Door':"R30' Self pass through 10' solid twice",
  ...
  'Plant Growth':"R160' Vegetation in ${lvl*400}' sq becomes thick and entangled",
  'Polymorph Object':"R$L5' Transform any object",
  ...
  'Pyrotechnics':"R160' Target fire emits fireworks (blind 1d4+1 rd) or obscuring smoke",
  ...
  'Stone Shape':"Touched $Lplus3' cu rock reshaped",
  ...
  'Unseen Servant':"R30' Invisible force does simple tasks w/in 30' for $Lplus6 turns",
  ...
  'Wall Of Fire':"R80' $L20' sq wall or $L5' radius circle 4d4+1 HP to passers, 2d4 w/in 10', 1d4 w/in 20' for conc/$L rd",
  ...
  'Water Breathing':"Touched breathe water (rev air) for $L6 turns",
